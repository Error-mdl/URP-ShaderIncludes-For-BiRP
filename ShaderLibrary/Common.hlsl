...
// Unity went WAY overzealous with half precision on mobile, then disabled warnings about downcasting. Half of their functions
// silently downcast to half because of the "real" macro, even when you very definitely want full precision. Break all kinds of
// shit, including most of unity's own lighting code in the URP. As usual, unity didn't actually bother to test their shit on mobile...
...
//VRC is currently only dx11 on PC and gles3 on quest
#if defined(SHADER_API_GLES3)
#include "Packages/com.error.birptourp/ShaderLibrary/API/GLES3.hlsl"
#else
#include "Packages/com.error.birptourp/ShaderLibrary/API/D3D11.hlsl"
#endif

#include "Packages/com.error.birptourp/ShaderLibrary/Macros.hlsl"
#include "Packages/com.error.birptourp/ShaderLibrary/Random.hlsl"

//Skip native renderpass / SM6 stuff, completely unsupported in BiRP
...
// STOP USING FUCKING REAL FOR ALL YOUR DAMN FUNCTIONS UNITY. NO ONE WANTS THEIR FULL PRECISION NUMBERS TO GET ROUNDED EVERY TIME THEY CALL A UNITY FUNCTION.
// YOU EVEN CAME UP WITH MACROS FOR CREATING OVERLOADS OF ALL VECTOR TYPES WHICH HANDLE CREATING OVERLOADS FOR BOTH PRECISIONS. WHY DIDN"T YOU DO THAT
// FOR THE REST OF THE FUNCTIONS?

// I'll do it myself then
#include "Packages/com.error.birptourp/ShaderLibrary/MacrosExtra.hlsl"
#if (REAL_IS_HALF)
#define TEMPLATE_1D_1_REAL TEMPLATE_1D_1_HALF
#define TEMPLATE_1D_2_REAL TEMPLATE_1D_2_HALF
#define TEMPLATE_1D_3_REAL TEMPLATE_1D_3_HALF
#define TEMPLATE_2D_1_REAL TEMPLATE_2D_1_HALF
#define TEMPLATE_2D_2_REAL TEMPLATE_2D_2_HALF
#define TEMPLATE_2D_3_REAL TEMPLATE_2D_3_HALF
#define TEMPLATE_3D_1_REAL TEMPLATE_3D_1_HALF
#define TEMPLATE_3D_2_REAL TEMPLATE_3D_2_HALF
#define TEMPLATE_3D_3_REAL TEMPLATE_3D_3_HALF
#define TEMPLATE_4D_1_REAL TEMPLATE_4D_1_HALF
#define TEMPLATE_4D_2_REAL TEMPLATE_4D_2_HALF
#define TEMPLATE_4D_3_REAL TEMPLATE_4D_3_HALF
#else
#define TEMPLATE_1D_1_REAL TEMPLATE_1D_1_FLT
#define TEMPLATE_1D_2_REAL TEMPLATE_1D_2_FLT
#define TEMPLATE_1D_3_REAL TEMPLATE_1D_3_FLT
#define TEMPLATE_2D_1_REAL TEMPLATE_2D_1_FLT
#define TEMPLATE_2D_2_REAL TEMPLATE_2D_2_FLT
#define TEMPLATE_2D_3_REAL TEMPLATE_2D_3_FLT
#define TEMPLATE_3D_1_REAL TEMPLATE_3D_1_FLT
#define TEMPLATE_3D_2_REAL TEMPLATE_3D_2_FLT
#define TEMPLATE_3D_3_REAL TEMPLATE_3D_3_FLT
#define TEMPLATE_4D_1_REAL TEMPLATE_4D_1_FLT
#define TEMPLATE_4D_2_REAL TEMPLATE_4D_2_FLT
#define TEMPLATE_4D_3_REAL TEMPLATE_4D_3_FLT
#endif

TEMPLATE_1D_1_REAL(DegToRad, deg,
    {
        return deg * (PI / 180.0);
    })

TEMPLATE_1D_1_REAL(RadToDeg, rad, 
    {
    return rad * (180.0 / PI);
    })
...
// 9 VALU
TEMPLATE_1D_1_REAL(FastACosPos, inX,
{
    real x = abs(inX);
...
// 12 VALU
TEMPLATE_1D_1_REAL(FastACos, inX,
{
...
TEMPLATE_1D_1_REAL(FastATanPos, x,
{
...
TEMPLATE_1D_1_REAL(FastATan, x,
{
    real t0 = FastATanPos(abs(x));
    return (x < 0.0) ? -t0 : t0;
})

TEMPLATE_1D_2_REAL(FastAtan2, y, x,
{
...
TEMPLATE_3D_2_REAL(Orthonormalize, tangent, normal,
{
...
TEMPLATE_2D_2_REAL(RemapHalfTexelCoordTo01, coord, size,
{
...
TEMPLATE_2D_2_REAL(Remap01ToHalfTexelCoord, coord, size,
{
...
TEMPLATE_1D_1_REAL(Smoothstep01, x,
{
    return x * x * (3 - (2 * x));
})

TEMPLATE_1D_1_REAL(Smootherstep01, x,
{
    return x * x * x * (x * (x * 6 - 15) + 10);
})

TEMPLATE_1D_3_REAL(Smootherstep, a, b, t,
{
    real r = rcp(b - a);
...
TEMPLATE_3D_1_REAL(SafeNormalize, inVec,
{
...
TEMPLATE_1D_2_REAL(SafeDiv, numer, denom,
{
    return (numer != denom) ? numer / denom : 1;
})

// Perform a square root safe of imaginary number.
TEMPLATE_1D_1_REAL(SafeSqrt, x,
{
    return sqrt(max(0, x));
})
